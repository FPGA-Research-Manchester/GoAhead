...
{
    public partial class AddXDLLibraryElementForm : Form
    {
        public AddXDLLibraryElementForm()
        {
            InitializeComponent();
        ...
        private void AddMacroForm_FormClosed(object sender, FormClosedEventArgs e)
        {
