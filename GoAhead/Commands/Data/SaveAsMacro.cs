...
{
    [CommandDescription(Description = "Save a netlist to files. This command shall only be used for netlists that contain a read in design, e.g via ReadDesign.", Wrapper = true, Publish = true)]
    class SaveAsMacro : Command
    {
        protected override void DoCommandAction()
        {
            FPGA.FPGATypes.AssertBackendType(FPGA.FPGATypes.BackendType.ISE);
            //TODO FPGA.FPGATypes.AssertBackendType(FPGA.FPGATypes.BackendType.ISE, FPGA.FPGATypes.BackendType.Vivado);
            ...
            switch (FPGA.FPGA.Instance.BackendType)
            {
                case FPGA.FPGATypes.BackendType.ISE:
                    ...
                    genCmd.IncludeModuleFooter = true;
                    genCmd.IncludeModuleHeader = true;
